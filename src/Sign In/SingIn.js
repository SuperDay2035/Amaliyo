    ...
    <div className="apps">
     ...
     <div className="container py-5">
      ...
      <div className="form-wrapper">
        ...
        <div className="form-state">
          <h5>Your username</h5>
          <input errorusername={errorusername.to} value={username} onChange={e=>setusername(e.target.value)} type="text" name="email" placeholder="Your Username" />
          {errorusername?
        ...
        <div className="form-state">
          <h5>Your Password</h5>
          <input errorpassword={errorpassword.toString()} value={password} onChange={e=>setpassword(e.target.value)} type="text" name="email" placeholder="Your Password" />
          {errorpassword?
            <label className="erorr-message" >Parolingizni Kiriting</label> : ""
          }
        </div>
        </form>
        ...
        <div className="sign-in">
          <p>Already Signed up? <a href="#">Go to Sign Up</a></p>
        </div>
